...
{{-- head --}}
@include('layouts.components.master._head')

<body>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            {{-- sidebar --}}
            @include('layouts.components.master._navbar')
            {{-- sidebar --}}
            @include('layouts.components.master._sidebar')
            ...
            {{-- footer --}}
            @include('layouts.components.master._footer')
        </div>
    </div>

    {{-- scripts --}}
    @include('layouts.components.master._scripts')
</body>
